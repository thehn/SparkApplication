...
@Controller
public class SvcClassifierController {

	public static Gson gson = new Gson();
	static final String fileNameWithoutExtension = "svc_predicted";
	final static Logger logger = LoggerFactory.getLogger(SvcClassifierController.class);

	/**
	 * Send Svc-Classifier request to Spark Rest API server
	 * 
	 * @param settings
	 * @param result
	 * @param model
	 * @return
	 */
	@RequestMapping(value = "/request-SvcTrain", method = RequestMethod.POST)
	public ModelAndView requestSvcClassifier(@ModelAttribute("appProperties") SvcClassifierSettings settings,
		...
		try {
			...
			SvcClassifierResponse objResponse = gson.fromJson(jsonResponse, SvcClassifierResponse.class);
			...
			return new ModelAndView("classification_svc_trainingResult");
		} catch (Exception e) {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/request-SvcPredict", method = RequestMethod.POST)
	public ModelAndView requestSvcPredict(@ModelAttribute("appProperties") SvcClassifierSettings settings,
			BindingResult result, ModelMap model) {

		String jsonResponse = "";
		try {
			// TODO - hard setting
			settings.setDataInputOption(SvcClassifierSettings.INPUT_FROM_FILE);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/schedule-mvc", method = RequestMethod.POST)
	@ResponseBody
	public String requestSchedule(@ModelAttribute("appProperties") SvcClassifierSettings settings, BindingResult result,
			ModelMap model) {
	 ...
	 * @throws IOException
	 */
	static void parsePredictionMetrics(SvcClassifierResponse objResponse, ModelMap model, boolean saveToFile)
			throws IOException {
	 ...
	 */
	@RequestMapping(value = "/request-SvcModelDetail", method = RequestMethod.POST)
	public ModelAndView requestSvcModelDetail(@ModelAttribute("appProperties") SvcClassifierSettings settings,
		...
		SvcClassifierResponse response = gson.fromJson(strResponse, SvcClassifierResponse.class);
		...
		return new ModelAndView("classification_svc_modelEvaluationMetrics");
	}
	...
	static void parseEvaluationMetrics(SvcClassifierResponse objResponse, ModelMap model) {
		// get metrics from response, parse them to web model
