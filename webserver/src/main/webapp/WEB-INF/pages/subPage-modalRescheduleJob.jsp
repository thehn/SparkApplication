<!-- Setting Page -->
<div class="modal fade" id="rescheduler" tabindex="-1"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="modal-title">Schedule editor</h3>
			</div>
			<div class="modal-body">
				...
				<form id="scheduleSettingsForm" onsubmit="return false"
					...
					<div class="form-group">
						...
						<textarea name="description" class="form-control" placeholder="Optional" readonly></textarea>
					</div>
					<div class="form-group">
				...
				<div class="btn-group btn-group-justified" role="group"
					...
					<div class="btn-group" role="group">
						<button type="button" class="btn btn-md btn-success pull-right"
							id="btnRequestSchedule" role="button">Reschedule</button>
					</div>
				</div>
			</div>
