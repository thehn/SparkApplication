...
<html lang="en">
<head>
	<title>Linear Support Vector Classifier</title>
	<!-- all libraries -->
	...
	<script src="<spring:url value="/resources/js/svc-algorithm.js?6.0"/>" type="text/javascript"></script>
	...
	<div class="container" id="container">
		...
		<div class="tab-content">
			<div id="trainingTab" class="tab-pane fade in active">
				<h2 class="algorithm-header">Linear Support Vector Classifier (SVC)</h2>
				<div class="panel panel-main">
					...
					<div class="panel-body" id="ml_form">
						<div class="form-group col-md-12">
							...
							<form method="POST" id="algorithmSettingForm"
								...
								<input name="algorithm" value=SvcClassifier style="display: none;">
									...
									<div class="panel-body">
										...
										<div class="row">
											<div class="form-group col-md-12">
												...
												<div class="col-md-3">
													<label class="control-label" for="threshold" data-toggle="tooltip" title="Default: 0.0">Threshold</label>
													<input name="threshold" type="number" placeholder="Optional"
													class="form-control input-md">
												</div>
												<div class="col-md-3">
					...
					<div class="panel-footer">Linear Support Vector Classifier</div>
				</div>
			...
			<div id="predictionTab" class="tab-pane fade">
				...
				<div class="panel panel-main">
					<div class="panel-heading">
						<strong>Linear Support Vector Classifier - Predicting</strong>
					</div>
					<div class="panel-body">
