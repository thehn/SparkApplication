...
<head>
	...
	<script src="<spring:url value="/resources/js/nb-algorithm.js?6.0"/>" type="text/javascript"></script>
		...
		<div class="container" id="container">
			...
			<div class="tab-content">
				<div id="trainingTab" class="tab-pane fade in active">
					<h2 class="algorithm-header">Naive Bayes</h2>
					<div class="panel panel-main">
						...
						<div class="panel-body" id="ml_form">
							<div class="form-group col-md-12">
								...
								<form method="POST" id="algorithmSettingForm"
									...
									<input name="algorithm" value=NaiveBayesClassifier style="display: none;">
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<div class="row">
												<div class="form-group col-md-12">
													<div class="col-md-4">
														<label class="control-label" for="fraction">Split for training / test</label>
														<input type="range" id="rangeData" value="80" min="0" max="100" step="5" defaultValue="80" name="fraction">
														<span>Ratio: <span id="range_value">80 / Non-split</span></span>
													</div>
													<div class="col-md-4">
														<label class="control-label" for="modelName" data-toggle="tooltip" title="If not choose, it will be saved as default model name.">Save Model As</label>
														<input id="modelName" name="modelName" type="text" placeholder="Optional, no space" class="form-control input-md">
													</div>
													<div class="col-md-4">
														<label class="control-label" for="lambda" data-toggle="tooltip" title="The smoothing parameter. Default: 1.0">Lambda</label>
														<input name="lambda" type="number" min="0" step="0.1" placeholder="Optional"
						...
						<div class="panel-footer">Naive Bayes</div>
					</div>
				...
				<div id="predictionTab" class="tab-pane fade">
					...
					<div class="panel panel-main">
						<div class="panel-heading">
							<strong>Naive Bayes - Predicting</strong>
						</div>
						<div class="panel-body">
							...
							<form method="POST" id="predictionForm"
								...
								<!-- <input name="header" id="header" style="display: none;"> --> <!-- #PC0005 -->
								<input name="fieldsForPredict" style="display: none;" id='fieldsForPredict'> <!-- #PC0005 -->
								
								<!-- #PC0005 - Start this panel was hidden -->
								<!-- <div class="panel panel-default panel-collapse collapse"
										...
										<div class="col-md-10">
											<div class="row" style="height: 100%;">
												<div class="panel panel-default" style="margin-left: 5px;">
													<div class="panel-heading">
														<strong>Model evaluation indices</strong>
													</div>
