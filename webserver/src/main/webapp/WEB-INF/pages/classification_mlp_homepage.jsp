...
<html lang="en">
<head>
	<title>Multiple Layers Perceptron</title>
	<!-- all libraries -->
	...
	<script src="<spring:url value="/resources/js/mlp-algorithm.js?6.0"/>" type="text/javascript"></script>
	...
	<div class="container" id="container">
		...
		<div class="tab-content">
			<div id="trainingTab" class="tab-pane fade in active">
				<h2 class="algorithm-header">Multiple Layers Perceptron</h2>
				<div class="panel panel-main">
					...
					<div class="panel-body" id="ml_form">
						<div class="form-group col-md-12">
							...
							<form method="POST" id="algorithmSettingForm"
								...
								<input name="algorithm" value=MLPClassifier style="display: none;">
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<div class="row">
											<div class="form-group col-md-12">
												<div class="col-md-2">
													<label class="control-label" for="numFeatures" data-toggle="tooltip" title="Number of atributes in features. (Automatically setting)">Input Layer</label>
														<input name="numFeatures" id="numFeatures" type="number" min="1"
														class="form-control input-md" required readonly>
												</div>
												<div class="col-md-2">
													<label class="control-label" for="numClasses" data-toggle="tooltip" title="Number of classes for training/predicting. (Automatically setting)">Output Layer</label>
														<input name="numClasses" id="numClasses" type="number" min="1"
														class="form-control input-md" readonly>
												</div>
												
												<div class="col-md-2">
													<label class="control-label" for="sizeInterLayer1" data-toggle="tooltip" title="Size of hidden layer 1. Default: 6">Hidden Layer 1</label>
													<input name="sizeInterLayer1" type="number" min="1" placeholder="Optional"
													class="form-control input-md">
												</div>
												<div class="col-md-2">
													<label class="control-label" for="sizeInterLayer2" data-toggle="tooltip" title="Size of hidden layer 2. Default: 8">Hidden Layer 2</label>
													<input name="sizeInterLayer2" type="number" min="1" placeholder="Optional"
													class="form-control input-md">
												</div>
												<div class="col-md-2">
													<label class="control-label" for="blockSize" data-toggle="tooltip" title="Default: 128">Block Size</label>
													<input name="blockSize" type="number" min="1" placeholder="Optional"
													class="form-control input-md">
												</div>
												<div class="col-md-2">
													<label class="control-label" for="maxIter" data-toggle="tooltip" title="Default: 10">Max Iteration</label>
													<input name="maxIter" type="number" min="1" placeholder="Optional"
													class="form-control input-md">
												</div>
					...
					<div class="panel-footer">Multiple Layers Perceptron</div>
				</div>
			...
			<div id="predictionTab" class="tab-pane fade">
				...
				<div class="panel panel-main">
					<div class="panel-heading">
						<strong>Multiple Layers Perceptron - Predicting</strong>
					</div>
					<div class="panel-body">
