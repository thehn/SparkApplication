var requestTrainUrl = "request-RfcTrain";
var requestPredictUrl = "request-RfcPredict";
var requestModelDetail = "request-RfcModelDetail";
var requestUploadUnlabeledFile = "request-SendFileToRestServer";
var requestDeleteModel = "deleteModel/RandomForestClassifier/";
var isTrainingTab = true;
var isPredictionTab = false;
var requestScheduleUrl ="schedule-rfc";
/*var algorithmName = "RandomForestClassifier";*/ // #PC0012

$(function() {
	
	// update algorithm name
	algorithmName = "RandomForestClassifier"; // #PC0012
	...
	$('#btnUploadUnlabeledFile').on('click', function() {
		if($('#dataDelimiter').val() != ''){
			...
			$.ajax({
				...
				updateSelectionFieldsForPredict(header, delimiter);*/
				// #P00005 - End
				$('#uploadedFileName').val(fileName);
				$("#btnPredict").removeAttr('disabled');
				$("#btnShowScheduler_2").removeAttr('disabled');
				// $('#collapseFieldsSelectionForPredict').collapse('show'); // #P00005
