var requestTrainUrl = "request-NBTrain";
var requestPredictUrl = "request-NBPredict";
var requestModelDetail = "request-NBModelDetail";
var requestUploadUnlabeledFile = "request-SendFileToRestServer";
var requestDeleteModel = "deleteModel/NaiveBayesClassifier/";
var isTrainingTab = true;
var isPredictionTab = false;
var requestScheduleUrl ="schedule-nb";
/*var algorithmName = "NaiveBayesClassifier";*/ // #PC0012

$(function() {
	
	// update algorithm name
	algorithmName = "NaiveBayesClassifier"; // #PC0012
	...
	$('#btnUploadUnlabeledFile').on('click', function() {
		if($('#dataDelimiter').val() != ''){
			...
			$.ajax({
				...
				// $('#collapseFieldsSelectionForPredict').collapse('show'); // #PC0005
