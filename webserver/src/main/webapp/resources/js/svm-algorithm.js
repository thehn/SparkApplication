var requestTrainUrl = "request-SvmTrain";
var requestPredictUrl = "request-SvmPredict";
var requestModelDetail = "request-SvmModelDetail";
var requestUploadUnlabeledFile = "request-SendFileToRestServer";
var requestDeleteModel = "deleteModel/SvmClassifier/";
var requestScheduleUrl ="schedule-svm";
var isTrainingTab = true;
var isPredictionTab = false;
/*var algorithmName = "SvmClassifier";*/ // #PC0012

$(function() {
	
	// update algorithm name
	algorithmName = "SvmClassifier"; // #PC0012
	...
	// to set Elasticsearch _type to be the same with modelName (fixed)
