var requestTrainUrl = "request-LrTrain";
var requestPredictUrl = "request-LrPredict";
var requestModelDetail = "request-LrModelDetail";
var requestUploadUnlabeledFile = "request-SendFileToRestServer";
var requestDeleteModel = "deleteModel/LogisticRegressionClassifier/";
var isTrainingTab = true;
var isPredictionTab = false;
var requestScheduleUrl ="schedule-lr";

$(function() {
	
	// set algorithm name
	algorithmName = "LogisticRegressionClassifier"; // #PC0012
