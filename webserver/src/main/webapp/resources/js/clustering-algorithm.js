var requestTrainUrl = "request-Train";
var requestPredictUrl = "request-Predict";
...
var requestScheduleUrl ="schedule-clustering";
var clusterAlgorithm;

$(document).ready(function() {
	clusterAlgorithm = $('#clusterAlgorithm').val();
	document.title = clusterAlgorithm;
	requestModelDetail = requestModelDetail + clusterAlgorithm;
	requestDeleteModel = requestDeleteModel + clusterAlgorithm;
	switch(clusterAlgorithm){
		case 'KmeansClustering':{
			$('.kmeans').show();
			$('.kmeans>input[name="numClusters"]').prop('required', true);
			break;
		}
		case 'KMediodsClustering':{
			$('.kmediods').show();
			$('.kmediods>input').prop('required', true);
			break;
		}
		case 'DBSCAN':{
			$('.dbscan').show();
			// $('.dbscan>input').prop('required', true);
			break;
		}
	}
});
